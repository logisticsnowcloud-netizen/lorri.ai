    ...
    <section id="platform" ref={ref as any} style={{ background: "var(--bg)", padding: "28px 32px" }} className="max-md:py-6 max-md:px-4">
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 14px", borderRadius: 20, fontSize: 11, fontWeight: 700, letterSpacing: ".08em", textTransform: "uppercase", background: "var(--purpleLt)", border: "1px solid var(--border)", color: "#54af3a", marginBottom: 18 }}>Industry Use Cases & Innovations</div>
