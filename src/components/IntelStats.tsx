...
export default function IntelStats() {
  ...
  return (
    <section id="intelligence" ref={ref as any} style={{ background: "var(--bg2)", padding: "60px 32px", position: "relative", overflow: "hidden" }} className="max-md:py-10 max-md:px-4">
