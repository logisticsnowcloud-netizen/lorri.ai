...
export function ForShippers() {
  ...
  return (
    <section id="shippers" ref={ref as any} className="px-4 py-4 sm:px-6 lg:px-8" style={{ background: "var(--bg2)" }}>
      <div className="mx-auto max-w-[1200px]">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div style={{ animation: visible ? "fadeUp .7s ease both" : "none", opacity: visible ? undefined : 0 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "4px 12px", borderRadius: 20, fontSize: 10, fontWeight: 700, letterSpacing: ".08em", textTransform: "uppercase", background: "var(--purpleLt)", border: "1px solid var(--border)", color: "#393185", marginBottom: 10 }}>
            ...
            <h2 style={{ fontSize: "1.6rem", fontWeight: 900, color: "var(--text)", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: 10 }} className="text-[1.4rem] sm:text-[1.5rem] lg:text-[1.6rem]">
              Procure Freight<br />
              <span style={{ color: "#393185" }}>With Confidence</span>
            </h2>
            ...
            <button onClick={() => openDemoModal()} className="flex w-full items-center justify-center gap-2 sm:inline-flex sm:w-auto" style={{ background: "linear-gradient(135deg,#393185,#4D44A8)", color: "#fff", border: "none", padding: "13px 24px", borderRadius: 8, fontFamily: "Outfit,sans-serif", fontSize: 13, fontWeight: 700, cursor: "pointer", letterSpacing: ".05em", textTransform: "uppercase", boxShadow: "0 4px 20px rgba(57,49,133,0.4)" }}>
          ...
          <div style={{ animation: visible ? "fadeUp .7s .2s ease both" : "none", opacity: visible ? undefined : 0 }}>
            <div style={{ background: "var(--card)", border: "1.5px solid var(--border)", borderRadius: 20, padding: 20 }} className="sm:p-6">
              ...
              {[
                ...
                <div key={i} style={{ padding: "12px 0", borderBottom: i < 3 ? "1px solid var(--borderSm)" : "none", display: "grid", gridTemplateColumns: "minmax(0,1fr) auto", gap: 12, alignItems: "center" }}>
              ...
              >
                <span style={{ fontSize: 13, color: "#fff", fontWeight: 700, letterSpacing: ".04em", textAlign: "center" }}>🔓 Unlock Best Rates — Get Access</span>
              </button>
            </div>
          </div>
        </div>
