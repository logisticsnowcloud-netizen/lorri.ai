/**
 * BACKUP: Original centered layout — Logo + Search centered, tabs below.
 * To use this layout, import HeroCentered instead of Hero in Index.tsx.
 */
...
export default function HeroCentered({ dark }: { dark: boolean }) {
    ...
    <section id="hero" style={{ position: "relative", minHeight: "88vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "56px 24px 72px", overflow: "hidden", background: "var(--bg)" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", maxWidth: 780, width: "100%" }}>
        ...
        <div className="fu5" style={{ display: "flex", gap: 10, marginTop: 28, flexWrap: "wrap", justifyContent: "center", alignItems: "center" }}>
          ...
          <button onClick={() => window.location.href = "/global-grid"} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "11px 22px", borderRadius: 10, border: "1px solid var(--border)", background: "var(--card)", color: "var(--text)", fontFamily: "Outfit,sans-serif", fontSize: 13, fontWeight: 600, cursor: "pointer", transition: "all .25s" }}>
            <GlobeNetIcon />
